...
const CreateMentor = ({ fetchMentors }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://assigning-mentor-backend-67zm.onrender.com/api/mentors', { name, email });
        ...
        <div className='col-sm-11 col-md-10 col-lg-8 col-xl-6'>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className='d-flex justify-content-center'>
              <button className="btn btn-success" style={{border:'3px black solid'}} type="submit">Create Mentor</button>
            </div> 
          </form>
        </div>
      </div>
